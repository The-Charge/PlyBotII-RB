...
#include "Commands/AutonomusGroup.h"
#include "Commands/Drive.h"
#include "Commands/DriveTwoFeet.h"
#include "Commands/DriveXft.h"
...
OI::OI() {
	...
	quarterTurnCWButton = new JoystickButton(joystick1, 2);
	quarterTurnCWButton->WhenPressed(new QuarterTurnClockwise());
	...
	SmartDashboard::PutData("Autonomus Group", new AutonomusGroup());
